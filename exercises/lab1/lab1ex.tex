...
\\[1em]
Using the \verb|gd_factorise_masked| function (default learning rate and epochs, and a rank of 5), what rating do you predict the 5th user (column index 4) might give to the movie ``A Beautiful Mind''? What is the \emph{sum of squared error} of the resultant matrix, computed over the valid (e.g. unmasked) values?
